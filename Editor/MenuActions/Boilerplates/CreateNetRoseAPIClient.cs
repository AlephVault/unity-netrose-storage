    ...
    namespace MenuActions
    {
        namespace Boilerplates
        {
            public static class CreateNetRoseAPIClient
            {
                ...
                /// </summary>
                [MenuItem("Assets/Create/Aleph Vault/NetRose/Boilerplates/Create Single-Character Account storage API client", false, 205)]
                ...
                /// </summary>
                [MenuItem("Assets/Create/Aleph Vault/NetRose/Boilerplates/Create Multiple-Character Account storage API client", false, 206)]
